using GggDocsClassLibrary.DesignPatterns.FactoryPattern.msdnSample;
using GggDocsClassLibrary.DesignPatterns.FactoryPattern.msdnSample.Abstracts;
using GggDocsClassLibrary.DesignPatterns.FactoryPattern.msdnSample.Factories;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using System;
using System.Collections.Generic;

namespace GggDocsClassLibrary.DesignPatterns.FactoryPattern
{
    /// <summary>
