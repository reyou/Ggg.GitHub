...
{
    /// <summary>
    /// The ReadAsync method performs file read operations asynchronously
    /// https://docs.microsoft.com/en-us/dotnet/standard/parallel-programming/how-to-perform-action-when-a-dataflow-block-receives-data#robust-programming
    /// </summary>
    class DataflowExecutionBlocksAsync
    {
        ...
        public static void Run()
        {
            ...
            TransformBlock<string, int> countBytes = new TransformBlock<string, int>(async path => await CountBytesAsync(path));
