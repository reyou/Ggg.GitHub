...
namespace GggDataflowBlockWinForms
{
    /// <summary>
    ...
    public partial class Form1 : Form
    {
        ...
        /*Add the following method, CreateImageProcessingNetwork, to the Form1 class.
         This method creates the image processing network.*/
        ...
        ITargetBlock<string> CreateImageProcessingNetwork()
        {
            ...
            TransformBlock<string, IEnumerable<Bitmap>> loadBitmaps = new TransformBlock<string, IEnumerable<Bitmap>>(path =>
            {
                try
                {
            ...
            TransformBlock<IEnumerable<Bitmap>, Bitmap> createCompositeBitmap = new TransformBlock<IEnumerable<Bitmap>, Bitmap>(bitmaps =>
            {
                try
                {
            ...
            ActionBlock<Bitmap> displayCompositeBitmap = new ActionBlock<Bitmap>(bitmap =>
                {
                    // Display the bitmap.
                    ...
                    toolStripButtonChooseFolder.Enabled = true;
            ...
            ActionBlock<object> operationCancelled = new ActionBlock<object>(obj =>
                {
        ...
        private Bitmap CreateCompositeBitmap(IEnumerable<Bitmap> bitmaps)
        {
            ...
            BitmapData resultBitmapData = result.LockBits(new Rectangle(new Point(), result.Size),
                ImageLockMode.WriteOnly, result.PixelFormat);

            // Lock each source bitmap to create a parallel list of BitmapData objects.
            List<BitmapData> bitmapDataList = (from bitmap in bitmapArray
                                               select bitmap.LockBits(new Rectangle(new Point(), bitmap.Size),
                                                   ImageLockMode.ReadOnly, PixelFormat.Format32bppArgb)).ToList();
        ...
        private void toolStripButtonChooseFolder_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                toolStripButtonChooseFolder.Enabled = false;
